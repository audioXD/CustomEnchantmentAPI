...
public class CEAPICommand {
	...
	public final Visibility getVisibility() { return this.visibility; }
	...
	public final Plugin getActivePlugin() { return this.activePlugin; }
	...
	public final List<String> getAlias() { return new ArrayList<>(alias); }
	...
	public final List<CEAPICommand> getSubCommands() { return new ArrayList<>(subCommands); }
	...
	public final List<Requirement> getRequirements() { return new ArrayList<>(requirements); }
	...
	public final List<Parameter<?>> getParameters() { return this.parameters; }
	...
	public boolean isOverflowSensitive() { return overflowSensitive; }
	...
	public boolean isArgsValid(List<String> args, CommandSender sender) {
		if (args.size() < this.getParameterCountRequired(sender)) {
			if (sender != null) {
				sender.sendMessage(CustomEnchantmentAPI.getInstance().getLanguageConfig().NOT_ENOUGH_ARGUMENTS.format());
			}
			return false;
		}
		if (args.size() > this.getParameterCount(sender) && this.isOverflowSensitive()) {
			if (sender != null) {
				...
				sender.sendMessage(CustomEnchantmentAPI.getInstance().getLanguageConfig().TO_MANY_ENOUGH_ARGUMENTS.format(theTooMany.toString()));
			}
			return false;
		}
	...
	public boolean isArgsValid(List<String> args) { return this.isArgsValid(args, null); }
	...
	public String getFullCommand() { return this.fullCommand;}
	...
	public List<CEAPICommand> getChain() { return new ArrayList<>(this.chain);}
	...
	private final void execute(CommandSender sender, List<String> args, List<CEAPICommand> chain) {
		try {
			...
			if(this.isParent() && args.size() > 0) {
				...
				sender.sendMessage(CustomEnchantmentAPI.getInstance().getLanguageConfig().UNKNOWN_COMMAND.format(this.getFullCommand()));
				return;
			}
	...
	public final int getNextArg() { return nextArg; }
	...
	public boolean argIsSet() { return this.argIsSet(nextArg); }

	public String arg() { return this.argAt(nextArg); }
	...
	public final CommandSender getSender() { return sender; }

	protected Player me = null;
	public final Player getMe() { return me;}

	protected boolean senderIsConsole = true;
	public final boolean isSenderIsConsole() { return senderIsConsole; }
	...
	private static class DefailtExecutor implements TabExecutor {
		...
		public DefailtExecutor(CEAPICommand com) { this.com = com; }
