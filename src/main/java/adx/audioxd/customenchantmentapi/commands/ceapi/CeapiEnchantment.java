...
public class CeapiEnchantment extends CEAPICommand {
	...
	public void perform() throws CEAPICommandException {
		RegisteredEnchantment registeredEnchantment = EnchantmentRegistry.getFromID(this.getArgs().get(0));
		Enchantment enchantment = registeredEnchantment.getEnchantment();

		sender.sendMessage(Text.parse("&r -------------&6[&r" + enchantment.getDisplay("").trim() + "&6]&r-------------&r"));
