...
public abstract class TypeAbstract<T> implements Type<T> {
	...
	@Override public final T read(CommandSender sender) throws TypeException { return this.read(null, sender); }
	@Override public final T read(String arg) throws TypeException { return this.read(arg, null); }
	@Override public final T read() throws TypeException { return this.read(null, null); }

	@Override public boolean isValid(String arg, CommandSender sender) {
		try {
			this.read(arg, sender);
			return true;
		} catch (TypeException ex) { return false; }
	}

	@Override public Collection<String> getTabList(CommandSender sender, String arg) { return null; }
	@Override public final List<String> getTabListFiltered(CommandSender sender, String arg) {
